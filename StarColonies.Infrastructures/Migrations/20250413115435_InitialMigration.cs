    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ColonsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Investit un soldat supplémentaire pour les 3 prochaines missions", new TimeSpan(0, 0, 3, 0, 0), "Equipe de pouce" },
                    { 3, "Augmente temporairement l'endurance de tous les membres d'une équipe", new TimeSpan(0, 0, 20, 0, 0), "Potion d'endurance" },
                    { 4, "Double le nombre de ressources obtenues pour 1 mission", new TimeSpan(0, 0, 10, 0, 0), "Grâce de Midas" },
                    { 5, "Chaque colon se voit octroyer une vie supplémentaire (endurance ×2)", new TimeSpan(0, 0, 10, 0, 0), "Seconde chance" },
                    { 6, "Elimine instantanément tous les ministres", new TimeSpan(0, 1, 40, 0, 0), "Litem trop cheats" }
                });
