...
namespace StarColonies.Web.Pages
{
    ...
    public class EditTeamModel : PageModel
    {
        ...
        private readonly ILogger<EditTeamModel> _logger;
        ...
        public async Task<IActionResult> OnGetAsync(string slug)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("L'utilisateur n'est pas le créateur de cette équipe");
        ...
        public async Task<IActionResult> OnPostAsync()
{
    ...
    // Récupérer les membres actuels de l'équipe
    var currentMembers = await _teamRepository.GetMembersOfTeam(team);
    ...
    try
    {
        ...
        {
            _logger.LogInformation("Upload de nouveau logo: {Filename}", LogoFile.FileName);
        ...
        {
            _logger.LogInformation("Upload de nouvelle bannière: {Filename}", BaniereFile.FileName);
        ...
        foreach (var colonId in membersToRemove)
        {
            ...
            var colon = await _colonRepository.GetColonByIdAsync(colonId);
            _teamRepository.RemoveMemberToTeam(team, colon);
        }
    ...
    {
        _logger.LogError(ex, "Erreur lors de la mise à jour de l'équipe: {TeamId}", TeamId);
        ...
        private async Task<string> UploadFile(IFormFile file, string subDirectory)
        {
            try
            {
                ...
                string uploadsFolder = Path.Combine(_webHostEnvironment.WebRootPath, "uploads", subDirectory);
